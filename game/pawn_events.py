...
THE_ASK_REQUESTS = [
    ...
    # ==================== UNKNOWN ITEM POOL REQUESTS ====================
    # These reward the mysterious ultra-rare items

    {
        "id": "something_soft",
        "item_name": "Something Velvet",
        "flavor": "I need something velvet. Doesn't matter what. Just soft. Soft enough that I can hear it whisper.",
        "reward_coins": 520,
        "reward_tickets": 5,
        "reward_exclusive": "velvet_static_wings",
        "difficulty": "hard",
    },
    {
        "id": "lost_receipts_stack",
        "item_name": "Old Receipt Stack",
        "flavor": "Find me a stack of old receipts. Dates don't matter. I want to see what people threw away. What they forgot about.",
        "reward_coins": 480,
        "reward_tickets": 4,
        "reward_exclusive": "halo_lost_receipts",
        "difficulty": "medium",
    },
    {
        "id": "sound_source",
        "item_name": "Something That Echoes",
        "flavor": "Bring me something that holds sound. Anything. A tape, a record, a bell. Something that remembers.",
        "reward_coins": 380,
        "reward_tickets": 3,
        "reward_exclusive": "echo_charm",
        "difficulty": "medium",
    },
    {
        "id": "silver_or_moon",
        "item_name": "Silver or Moonlike Thing",
        "flavor": "Something silver. Something that glows. Something wire-thin and impossible. Make sense of that. 24 hours.",
        "reward_coins": 420,
        "reward_tickets": 3,
        "reward_exclusive": "moonwire_gloves",
        "difficulty": "medium",
    },
    {
        "id": "dark_fabric",
        "item_name": "Dark Soft Fabric",
        "flavor": "I need fabric. Dark fabric. Comfortable-looking. The kind of thing you could disappear into.",
        "reward_coins": 390,
        "reward_tickets": 3,
        "reward_exclusive": "gloomlace_hoodie",
        "difficulty": "easy",
    },
    {
        "id": "darkness_in_glass",
        "item_name": "Glass or Dark Object",
        "flavor": "Find me darkness you can hold. A jar filled with shadows. A glass filled with night. Something small. Something private.",
        "reward_coins": 550,
        "reward_tickets": 5,
        "reward_exclusive": "pocket_eclipse",
        "difficulty": "hard",
    },
    {
        "id": "pawnbroker_secret",
        "item_name": "Something Whispered",
        "flavor": "You know what I mean. The thing nobody should carry. The secret that sounds like me. Find it. Don't ask questions.",
        "reward_coins": 410,
        "reward_tickets": 3,
        "reward_exclusive": "pawns_whisper",
        "difficulty": "hard",
    },
    {
        "id": "lucky_found_object",
        "item_name": "Lucky Object",
        "flavor": "Bring me something that feels lucky. Don't overthink it. You'll know when you see it.",
        "reward_coins": 320,
        "reward_tickets": 2,
        "reward_exclusive": "lucky_thread_spool",
        "difficulty": "easy",
    },
    {
        "id": "broken_mirror",
        "item_name": "Broken Mirror",
        "flavor": "I need a cracked mirror. Something small. Small enough to fit in a pocket. Show me your reflection and someone else's at once.",
        "reward_coins": 300,
        "reward_tickets": 2,
        "reward_exclusive": "cracked_little_mirror",
        "difficulty": "easy",
    },
    {
        "id": "rat_bone_relic",
        "item_name": "Rat Bone or Relic",
        "flavor": "Something from the rats. A bone. A tooth. Something blessed by the alleys. They know what's holy down here.",
        "reward_coins": 400,
        "reward_tickets": 3,
        "reward_exclusive": "rat_saint_relic",
        "difficulty": "medium",
    },
    {
        "id": "mechanical_soft_thing",
        "item_name": "Soft Mechanical Part",
        "flavor": "Something mechanical that's also tender. A heart-shaped part. An engine piece that feels alive. I don't know. Find it.",
        "reward_coins": 540,
        "reward_tickets": 5,
        "reward_exclusive": "soft_engine_heart",
        "difficulty": "hard",
    },
    {
        "id": "cassette_or_tape",
        "item_name": "Tape or Cassette",
        "flavor": "An old tape. Could be anything on it. Radio. Music. Someone's voice. I want to hear the static in between. Bring it.",
        "reward_coins": 430,
        "reward_tickets": 3,
        "reward_exclusive": "midnight_broadcast_tape",
        "difficulty": "medium",
    },
    {
        "id": "thread_from_nowhere",
        "item_name": "Thread or String",
        "flavor": "Fine thread. Quality thread. The kind that holds things together without you noticing. One piece. That's all I need.",
        "reward_coins": 310,
        "reward_tickets": 2,
        "reward_exclusive": "thread_hollow_coat",
        "difficulty": "easy",
    },
    {
        "id": "watching_eye",
        "item_name": "Glass Eye or Round Object",
        "flavor": "Something that looks like it's watching. Glass. Round. Eye-like. Bring it to me. It'll know where it belongs.",
        "reward_coins": 560,
        "reward_tickets": 5,
        "reward_exclusive": "glass_eye_alley_mercy",
        "difficulty": "hard",
    },
]
...
EXCLUSIVE_REWARDS = {
    ...
    # ==================== UNKNOWN ITEM POOL ====================
    # Ultra-rare items with mysterious, eerie, cute flavor
    # Only available from special Pawn Owner events
    ...
    "velvet_static_wings": {
        ...
        "effects": {"rare_chance": 0.20, "xp_boost": 0.15},
    },
    "halo_lost_receipts": {
        ...
        "effects": {"coin_boost": 0.18, "extra_item_chance": 0.12},
    },
    "echo_charm": {
        "name": "Echo Charm",
        "emoji": "🔔",
        ...
        "effects": {"rare_chance": 0.12, "drop_bonus": 0.08},
    },
    "moonwire_gloves": {
    ...
    "pocket_eclipse": {
        ...
        "effects": {"next_draw_guarantee": True, "rare_chance": 0.25},
    },
    "pawns_whisper": {
        "name": "Pawn's Whisper",
        "emoji": "🤫",
        ...
        "effects": {"loot_value_boost": 0.20, "coin_boost": 0.15},
    },
    "lucky_thread_spool": {
        ...
        "effects": {"extra_item_chance": 0.10, "xp_boost": 0.08},
    },
    "cracked_little_mirror": {
        ...
        "effects": {"rare_chance": 0.08, "xp_boost": 0.12},
    },
    "rat_saint_relic": {
        ...
        "effects": {"drop_bonus": 0.15, "coin_boost": 0.10},
    },
    "soft_engine_heart": {
        ...
        "effects": {"rare_chance": 0.22, "loot_value_boost": 0.18},
    },
    "midnight_broadcast_tape": {
        ...
        "effects": {"next_dive_bonus": 0.30, "rare_chance": 0.15},
    },
    "thread_hollow_coat": {
        ...
        "effects": {"extra_item_chance": 0.08, "coin_boost": 0.06},
    },
    "glass_eye_alley_mercy": {
        ...
        "effects": {"rare_chance": 0.25, "loot_value_boost": 0.20, "extra_item_chance": 0.15},
    },
}
